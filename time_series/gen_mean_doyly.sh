...
do
	...
	gdal_calc.py --quiet --overwrite -A ${tmp_dir}/denominator_${doy}.tif \
		     --outfile=${tmp_dir}/denominator_${doy}.tif --calc="A*0"

	
    	imga_num=${tmp_dir}/numerator_${doy}.tif
    	imga_den=${tmp_dir}/denominator_${doy}.tif
	img_avg=${tmp_dir}/average_${doy}.tif
