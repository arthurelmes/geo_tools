...
def main():
    ...
    workspace = '/lovells/data02/arthur.elmes/greenland/vector/'
    csv_name = '65_deg_north_ice_clip_wgs84_pts_extracted_values_MCD43_actual_albedo.csv'
    aoi_name = '65 Deg Transect 1'
