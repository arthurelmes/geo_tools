...
for csv_name in csv_names:
    ...
    # TODO This dataframe should be initialized from the header in the big CSV, rather than hard-coded
    sample = pd.DataFrame(columns=['VJ143MA3.A2019009.002', 'VNP43MA3.A2019009.002'])
...
fig.savefig(workspace + year + '.png')
